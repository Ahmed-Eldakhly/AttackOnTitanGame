...
class Building {
    id = 0;
    constructor(images,width,height,positionx) {
        this.images = images;
        this.width = width;
        this.height=height;
        this.id = ++idCounter;
...
var building = new Building("demo2.png",600,600,"0px" );
var building2 = new Building("demo1.png",300,300,"600px" );
...
$(document).keydown(function (e) {
 ...
 $(".build-img").each((i)=>{ 
      ...
      //right 
    $(".build-img")[i].css('left', position += 20)});  }
})

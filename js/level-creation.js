    ...
    if (level == 1) {
        ...
        switch (character) {
            ...
            case 3:
                ...
                mainCharacter = new Characters(character, "Mrmin", 20, level, arminJumpPhotosArray, arminMovePhotosArray, arminLosePhotosArray, arminWinPhotosArray, document.getElementById("defenderPhotos"));
                break;
        }
    } else if (level == 2) {
